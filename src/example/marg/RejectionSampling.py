...
m_samples_path = "src/example/samples/mcmc_samples_prob.npy"   # your file
...
pairplot(m_samples, m_true=m_true,
                                 save_path="src/example/marg/results/mcmc.png")
pairplot(resampled_vi, m_true=m_true,
                                 save_path="src/example/marg/results/resampled_vi.png")
pairplot(resampled_marg, m_true=m_true,
                                 save_path="src/example/marg/results/resampled_marg.png")
